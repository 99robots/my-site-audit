...
<div class="nnr-header">
	...
	<div class="nnr-product-details">
		<span class="nnr-product-name"><?php _e(NNROBOTS_CONTENT_AUDIT_ITEM_NAME, self::$text_domain); ?></span>
		<span class="nnr-product-version"><?php echo NNROBOTS_CONTENT_AUDIT_VERSION_NUM; ?></span>
	</div>
